 ...
 * @return List of installed translations
 */
QStringList installSystemTranslation(
    const QString& name, const QLocale& locale = QLocale());
 ...
 */
QStringList
installUserTranslations(const QString& path, const QLocale& locale = QLocale());
