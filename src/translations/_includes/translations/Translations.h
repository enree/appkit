...
#define TR_N(DOMAIN, STRING, ...)                                              \
    ...
    (boost::locale::format(boost::locale::translate(STRING).str(DOMAIN)),      \
     __VA_ARGS__)
...
#define TR_PL_N(DOMAIN, STRING, STRING_PL, COUNT, ...)                         \
    VA_MACRO_NAME(TR_, __VA_ARGS__)                                            \
    (boost::locale::format(                                                    \
         boost::locale::translate(STRING, STRING_PL, COUNT).str(DOMAIN)),      \
     __VA_ARGS__)
...
#define TR_CTX_N(DOMAIN, CONTEXT, STRING, ...)                                 \
    VA_MACRO_NAME(TR_, __VA_ARGS__)                                            \
    (boost::locale::format(                                                    \
         boost::locale::translate(CONTEXT, STRING).str(DOMAIN)),               \
     __VA_ARGS__)
