...
public:
    ...
    typedef std::set<ProgramOption> ProgramOptions;
...
public:
     ...
     */
    ProgramOptions infoOptions(int argc, char** argv);
    ...
    void addSubtreeOption(
        const std::string& key,
        const std::string& description,
        const ConfigParser& subtreeParser)
    {
        verifyKey(key);
     ...
     */
    void printProgramOptionsUsage(std::ostream& stream, int indent) const;
...
private:
    ...
    O<T>& addOptionImpl(
        const std::string& key, const std::string& description, Setter setter)
    {
        verifyKey(key);
...
private:
    ...
    typedef std::map<std::string, std::string> KeySourceMap;
