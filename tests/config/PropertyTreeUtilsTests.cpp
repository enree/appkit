...
const std::string HOST = "test_node1.host";
const std::string PORT = "test_node1.port";
const std::string TOKEN = "test_node2.token";
const std::string ANY = "test_node3";
const std::string ANY1 = "test_node2.any.any_node1";
const std::string ANY2 = "test_node2.any.any_node2";
const std::string ANY4 = "test_node4";
const std::string ARRAY = "test_array";
